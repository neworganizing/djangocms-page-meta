...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'djangocms_page_meta_pagemeta', (
            ...
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='djangocms_page_meta_page', null=True, to=orm['filer.File'])),
            ('og_type', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('og_author', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True)),
        ...
        db.send_create_signal(u'djangocms_page_meta', ['PageMeta'])

        # Adding model 'TitleMeta'
        db.create_table(u'djangocms_page_meta_titlemeta', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='djangocms_page_meta_title', null=True, to=orm['filer.File'])),
            ...
            ('og_description', self.gf('django.db.models.fields.CharField')(default='', max_length=400, blank=True)),
            ('twitter_description', self.gf('django.db.models.fields.CharField')(default='', max_length=140, blank=True)),
            ('gplus_description', self.gf('django.db.models.fields.CharField')(default='', max_length=400, blank=True)),
        ))
        db.send_create_signal(u'djangocms_page_meta', ['TitleMeta'])


    def backwards(self, orm):
        # Deleting model 'PageMeta'
        db.delete_table(u'djangocms_page_meta_pagemeta')

        # Deleting model 'TitleMeta'
        db.delete_table(u'djangocms_page_meta_titlemeta')
    ...
    models = {
        ...
        u'djangocms_page_meta.pagemeta': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'djangocms_page_meta_page'", 'null': 'True', 'to': u"orm['filer.File']"}),
            'og_app_id': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            'og_author': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
        ...
        u'djangocms_page_meta.titlemeta': {
            ...
            'gplus_description': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '400', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'djangocms_page_meta_title'", 'null': 'True', 'to': u"orm['filer.File']"}),
            'keywords': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '400', 'blank': 'True'}),
            'og_description': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '400', 'blank': 'True'}),
            ...
            'twitter_description': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '140', 'blank': 'True'})
        },
        u'filer.file': {
